...
- policy для retry/refetch triggers и semantic equality фиксируется отдельно;
- realtime transport, ordering, recovery и race между GET и realtime patch
  определены в ADR 003.
